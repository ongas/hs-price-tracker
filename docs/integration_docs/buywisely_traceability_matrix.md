...
| Display user-friendly product name (not full <title>)   | parser.py, data_transformer.py | All product info test cases, real_buywisely_product.html | Extraction logs, entity state         | API contract, user story, BDD feature, checklist |
