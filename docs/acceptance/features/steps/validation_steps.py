...
@given(
    "I have a valid BuyWisely product URL (e.g., a buywisely.com.au product page for a product)"
)
...
@given(
    "I have an invalid BuyWisely product URL (e.g., an image link, a malformed URL, or a non-product page)"
)
